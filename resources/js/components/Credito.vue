                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      <option value="numeroprestamo">numeroprestamo</option>
                                      <option value="idkiva">idkiva</option>
                                    
                                    </select>
                                    <input type="text" v-model="buscar" @keyup.enter="listarCredito(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarCredito(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="credito in arrayCredito" :key="credito.id">
                                        <td>
                                            <button type="button" @click="verVenta(credito.id)" class="btn btn-success btn-sm">
                                            <i class="icon-eye"></i>
                                            </button> &nbsp;
                                        ...
                                        <td v-text="credito.tipocambio"></td>
                                        <td v-text="credito.tasa"></td>
                                         <td v-text="credito.estado"></td>
                                          <td v-text="credito.periodo"></td>
                                    </tr>                                
                                </tbody>
                            </table>
                        </div>
        ...
        methods : {
            listarCredito (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayCredito = respuesta.ventas.data;

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-09-2019 a las 01:49:15
...
(49, 14, 13, 'SM20150001', '847553', '1700.00', '2015-05-25', 12, '3.150000', '13.00', '1', '1', '2019-09-02 06:48:36', '2019-09-02 06:48:36'),
(50, 15, 13, 'SM20150002', '847562', '1700.00', '2015-05-25', 12, '3.150000', '11.00', '2', '1', '2019-09-03 08:37:40', '2019-09-03 08:37:40'),
(51, 16, 13, 'SM20150003', '847598', '1700.00', '2015-05-25', 12, '3.150000', '11.00', '1', '1', '2019-09-03 08:47:33', '2019-09-03 08:47:33'),
(52, 37, 13, '45', '45', '1200.00', '2019-09-14', 4, '3.150000', '13.00', '1', '1', '2019-09-09 21:53:03', '2019-09-09 21:53:03'),
(53, 18, 13, 'SM00005854', '1245325', '1800.00', '2019-09-11', 4, '3.150000', '11.00', '1', '1', '2019-09-11 22:24:20', '2019-09-11 22:24:20'),
(54, 17, 13, 'SM0058', '1232654', '1700.00', '2019-09-11', 12, '3.250000', '11.00', '1', '1', '2019-09-12 02:49:14', '2019-09-12 02:49:14'),
(55, 41, 13, 'aaaasdas45', 'asdasd4564', '1700.00', '2019-09-11', 12, '3.150000', '11.00', '1', '1', '2019-09-12 03:21:15', '2019-09-12 03:21:15'),
(56, 43, 13, 'asdasd45', 'asdasd', '1200.00', '2019-09-11', 4, '3.150000', '11.00', '1', '3', '2019-09-12 04:53:40', '2019-09-12 04:53:40'),
(57, 44, 13, 'sm0000', 'ki00045', '1200.00', '2019-09-12', 4, '3.150000', '11.00', '1', '1', '2019-09-13 01:31:17', '2019-09-13 01:31:17');

--
-- Disparadores `creditos`
--
DELIMITER $$
CREATE TRIGGER `actualizarcredito` AFTER UPDATE ON `creditos` FOR EACH ROW INSERT INTO creditos_bitacora(idcliente_n,idusuario_n,numeroprestamo_n,idkiva_n,montodesembolsado_n,fechadesembolso_n,numerocuotas_n,tipocambio_n,tasa_n,estado_n,periodo_n,idcliente_v,idusuario_v,numeroprestamo_v,idkiva_v,montodesembolsado_v,fechadesembolso_v,numerocuotas_v,tipocambio_v,tasa_v,estado_v,periodo_v,condicion)
VALUES(NEW.idcliente,NEW.idusuario,NEW.numeroprestamo,NEW.idkiva,NEW.montodesembolsado,NEW.fechadesembolso,NEW.numerocuotas,NEW.tipocambio,NEW.tasa,NEW.estado,NEW.periodo,old.idcliente,old.idusuario,old.numeroprestamo,old.idkiva,old.montodesembolsado,old.fechadesembolso,old.numerocuotas,old.tipocambio,old.tasa,old.estado,old.periodo,'CREDITO ACTUALIZADO')
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `insertarcredito` AFTER INSERT ON `creditos` FOR EACH ROW INSERT INTO creditos_bitacora(idcliente_n,idusuario_n,numeroprestamo_n,idkiva_n,montodesembolsado_n,fechadesembolso_n,numerocuotas_n,tipocambio_n,tasa_n,estado_n,periodo_n,condicion)
VALUES(NEW.idcliente,NEW.idusuario,NEW.numeroprestamo,NEW.idkiva,NEW.montodesembolsado,NEW.fechadesembolso,NEW.numerocuotas,NEW.tipocambio,NEW.tasa,NEW.estado,NEW.periodo,'NUEVO CREDITO')
$$
DELIMITER ;
...
INSERT INTO `creditos_bitacora` (`id`, `idcliente_n`, `idcliente_v`, `idusuario_n`, `idusuario_v`, `numeroprestamo_n`, `idkiva_n`, `montodesembolsado_n`, `fechadesembolso_n`, `numerocuotas_n`, `tipocambio_n`, `tasa_n`, `estado_n`, `periodo_n`, `numeroprestamo_v`, `idkiva_v`, `montodesembolsado_v`, `fechadesembolso_v`, `numerocuotas_v`, `tipocambio_v`, `tasa_v`, `estado_v`, `periodo_v`, `condicion`, `fechacambio`) VALUES
(0, 44, 0, 13, 0, 'sm0000', 'ki000', '1200.00', '2019-09-12', 4, '3.150000', '11.00', '1', '1', '', '', '0.00', '0000-00-00', 0, '0.000000', '0.00', '', '', 'NUEVO CREDIT', '2019-09-12 20:31:17'),
(0, 44, 44, 13, 13, 'sm0000', 'ki00045', '1200.00', '2019-09-12', 4, '3.150000', '11.00', '1', '1', 'sm0000', 'ki000', '1200.00', '2019-09-12', 4, '3.150000', '11.00', '1', '1', 'CREDITO ACTUALIZADO', '2019-09-12 20:45:38'),
(0, 43, 43, 13, 13, 'asdasd45', 'asdasd', '1200.00', '2019-09-11', 4, '3.150000', '11.00', '1', '3', 'asdasd', 'asdasd', '1200.00', '2019-09-11', 4, '3.150000', '11.00', '1', '3', 'CREDITO ACTUALIZADO', '2019-09-12 20:46:02');
...
(147, 13, 49, 0, '2015-06-25', '2019-09-01 00:00:00', '1558.33', '157.25', '0.00', NULL, '0', '2019-09-02 06:48:36', '2019-09-02 06:48:36'),
...
(42, '7878', 'asdasd', 'sdfsd', 'asfsdf', '1993-03-01', 'asdfds', '1', 'sdfsdf@gmail.com', '1', '2019-09-12 04:52:42', '2019-09-12 04:52:42'),
...
(42, 'a', '$2y$10$vNMW./ZdGy20psp0VFieCOyBoJqM.ElM23q/uI/aHIYMz3msZ8hrW', 1, 1, NULL),
